...
public enum ReservationMenuOption {
    ...
    VIEW_RESERVATIONS_FOR_GUEST(4, "View Reservations for Guest", false),
    VIEW_RESERVATIONS_FOR_HOST(5, "View Reservations for Host", false),
    VIEW_RESERVATIONS_FOR_INACTIVE_HOST(6, "View Reservations for Inactive Host", false);
